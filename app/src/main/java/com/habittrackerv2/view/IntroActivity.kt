package com.habittrackerv2.view
...
import com.habittrackerv2.models.IntroView
import com.habittrackerv2.models.MainActivity
import com.habittrackerv2.viewmodels.ViewPagerIntroAdapter
...
class IntroActivity : AppCompatActivity() {
    ...
    private fun addToIntroView() {
        ...
        introView = listOf(
            ...
            IntroView("Good luck! Tap on the button below to get started with using the app!", R.drawable.ic_smoke_24),
        )
    }
}